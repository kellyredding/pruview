...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "bin/ffyml", "lib/pruview", "lib/pruview/document.rb", "lib/pruview/exceptions.rb", "lib/pruview/sRGB.icm", "lib/pruview/USWebCoatedSWOP.icc", "lib/pruview/version.rb", "lib/pruview/video.rb", "lib/pruview/video_image.rb", "lib/pruview.rb", "test/files", "test/files/basic.jpg", "test/files/basic.mpg", "test/files/error.jpg", "test/files/error.mov", "test/files/invalid_format.poop", "test/helper.rb", "test/unit", "test/unit/document_test.rb", "test/unit/video_image_test.rb", "test/unit/video_test.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mini_magick>, ["~> 2.1"])
      ...
      s.add_dependency(%q<mini_magick>, ["~> 2.1"])
